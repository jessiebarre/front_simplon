 ...
 **/
const monModuleChalk = require("chalk");
console.log(monModuleChalk.green("Chalk OK!"));
/**
 3.
 ...
 **/
console.log(monModuleChalk.red("Une erreur est survenue !"));
console.log(monModuleChalk.gray("Ceci est un message de debug !"));
console.log(monModuleChalk.bold("Ceci est un message important !"));
